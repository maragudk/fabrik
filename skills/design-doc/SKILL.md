---
name: design-doc
description: For when you're asked to write a design doc or specification, especially after a brainstorm or feature design session.
license: MIT
---
...
Design docs go into the `docs/design/` directory in the project root. Create the folder if it doesn't exist.
