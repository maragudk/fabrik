...
Work in two phases. First, review the code: read diffs, check logic, look for missing edge cases and test coverage gaps. Second, run automated checks: tests, linters, build. Produce a structured report with clear findings and a pass/fail verdict.
